...
.mfavyi {
  ...
  line-height: 1rem;
  --un-text-opacity: 1;
  color: rgba(0, 56, 122, var(--un-text-opacity));
}
...
.mo75vt:hover {
  --un-bg-opacity: 1;
  background-color: rgba(0, 72, 122, var(--un-bg-opacity));
}
...
.hgdohl {
  max-width: 430px;
  --un-bg-opacity: 1;
  background-color: rgba(0, 57, 122, var(--un-bg-opacity));
}
